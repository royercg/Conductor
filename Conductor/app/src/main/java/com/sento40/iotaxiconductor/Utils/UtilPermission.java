...
public class UtilPermission {
    ...
    public static void requestPermission(AppCompatActivity activity, int requestId,
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(activity, permission)) {
            ...
            UtilPermission.RationaleDialog.newInstance(requestId, finishActivity)
     ...
     * permission.
     * <p>
     * The activity should implement {@link ActivityCompat.OnRequestPermissionsResultCallback} to
     * handle permit or denial of this permission request.
     */
